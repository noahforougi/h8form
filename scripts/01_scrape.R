# ------------------------------------------------------------------------------------------------------------
# Script name: 01_scrape.R
#
# Purpose of script: This script scrapes the most current release of the H.8. Form on the Fed Website.
#
# Author: Noah Forougi
# ------------------------------------------------------------------------------------------------------------
...
dat %<>% 
  ...
  mutate(Account1 = gsub("[0-9]", "" ,Account1),
         date = ymd(date)) %>%
